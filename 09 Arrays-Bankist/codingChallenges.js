...
console.log("data 2");
console.log("---- Julia 2 ----");
checkDogs(dogsJulia2);
console.log("---- Kate 2 ----");
checkDogs(dogsKate2);

const correctJulia1 = dogsJulia1.slice(2, 3);
const both1 = dogsKate1.concat(correctJulia1);

const correctJulia2 = dogsJulia2.slice(2, 3);
const both2 = dogsKate2.concat(correctJulia2);
...
const checkEatingOk = (dog) =>
  dog.curFood > dog.curFood * 0.9 && dog.curFood < dog.recFood * 1.1;
